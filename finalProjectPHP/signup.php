				...
				<div class="  col-sm-5 col-xs-12 " style="margin-bottom: 100px;">
					...
					<form method="POST" action="sign.php">
						...
						<div class="form-group">
							...
							<div><?php //echo $_POST['email_error']; 
									?></div>
							<div><? php // echo $_GET['exist_error']; 
									?></div>
						</div>
						...
						<div class="form-group">
							<input type="text" class="form-control" name="contact" placeholder="Phone Number" required="true" pattern=".{10}">
							<div><?php //echo $_GET['contact_error']; 
									?></div>
						</div>
					...
					<br>
					<p>Aleady Registered? <a data-toggle="modal" data-target="#pz">Login</a> </p>
				</div>
			</div>
		</div>
