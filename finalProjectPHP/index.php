				...
				<div class=" col-md-4 col-sm-6 col-xs-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<button class="btn btn-primary form-control" data-product-number="1" type="button" value="Submit" name="btn" data-toggle="modal" data-target="#all">Add to Cart</button>
				...
				<div class=" col-md-4 col-sm-6 col-xs-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<button class="btn btn-primary form-control" data-product-number="2" type="button" value="Submit" name="btn" data-toggle="modal" data-target="#all">Add to Cart</button>
				...
				<div class=" col-md-4 col-sm-6 col-xs-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<button class="btn btn-primary form-control" data-product-number="3" type="button" value="Submit" name="btn" data-toggle="modal" data-target="#all">Add to Cart</button>
				...
				<div class=" col-md-4 col-sm-6 col-xs-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<button class="btn btn-primary form-control" data-product-number="4" type="button" value="Submit" name="btn" data-toggle="modal" data-target="#all">Add to Cart</button>
				...
				<div class=" col-md-4 col-sm-6 col-xs-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<button class="btn btn-primary form-control" data-product-number="5" type="button" value="Submit" name="btn" data-toggle="modal" data-target="#all">Add to Cart</button>
				...
				<div class=" col-md-4 col-sm-6 col-xs-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<button class="btn btn-primary form-control" data-product-number="6" type="button" value="Submit" name="btn" data-toggle="modal" data-target="#all">Add to Cart</button>
